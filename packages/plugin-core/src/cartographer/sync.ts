 ...
 *
 * Originally in packages/cc-plugin/src/cartographer/sync.ts; the acp
 * adapter keeps its own sync (different logger integration, non-optional
 * API key) for now. Future work could merge them by parameterising
