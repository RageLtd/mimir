...
const STYLES = `
:root{color-scheme:light dark;--bg:#f5f6f3;--surface:#fff;--text:#171a1f;--muted:#626b78;--line:#d7dcd3;--accent:#5946d2;--accent-text:#fff;--max:72rem}
